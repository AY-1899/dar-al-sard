document.addEventListener('DOMContentLoaded', () => {
    ...
    function openModal(bookId) {
        ...
        const frontPos = book.frontCoverSide === 'left' ? '0% 50%' : '100% 50%';
        const backPos  = book.frontCoverSide === 'left' ? '100% 50%' : '0% 50%';
        ...
        document.querySelector('.modal-action .btn-buy').onclick = () => {
            window.location.href = 'tel:07735926484';
        };
